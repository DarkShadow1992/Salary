                ...
                child: Scaffold(
                  ...
                  bottomNavigationBar: Container(
                    ...
                    decoration: BoxDecoration(
                        color: HexColor(controller.selectedBackColor)
                            .withOpacity(0.15),
                        borderRadius: BorderRadius.only(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          ...
                          child: Container(
                              decoration: BoxDecoration(
                                  color: HexColor(controller.navIndex.value == 2
                                          ? controller.selectedBackColor
                                          : "FFFFFF")
                                      .withOpacity(0.15),
                                  borderRadius: BorderRadius.only(
                                      topRight: Radius.circular(20.h))),
                        ...
                        Expanded(
                            child: GestureDetector(
                          child: Container(
                              color: HexColor(controller.navIndex.value == 3
                                      ? controller.selectedBackColor
                                      : "FFFFFF")
                                  .withOpacity(0.15),
                              width: 65.w,
                        ...
                        Expanded(
                            child: GestureDetector(
                          child: Container(
                              color: HexColor(controller.navIndex.value == 4
                                      ? controller.selectedBackColor
                                      : "FFFFFF")
                                  .withOpacity(0.15),
                              width: 65.w,
                                ...
                                children: [
                                  Expanded(
                                      child: Icon(
                                          ...
                                          color: HexColor("D9366C"))),
                                  Text('خروج',
                                      style: TextStyle(
                                          fontSize: 12.sp,
                                          fontWeight: FontWeight.bold,
                                          color: HexColor(
                                              controller.selectExitColor))),
                                  SizedBox(height: 5.h),
                                ],
                              )),
                          onTap: () {
